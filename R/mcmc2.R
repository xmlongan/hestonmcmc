...
#' Volatility Model using MCMC. Contrast to `mcmc()`, we replicate certain sub
#' iterations for each Metropolis sampler.
#' * `cmcmc2()` implemented in C++, returns only a vector of the estimated
#' parameters.
#' * `mcmc2()` implemented in R.
#'
#' @details 
...
#' that of parameters \eqn{\sigma_v,\rho}, and the hidden states \eqn{v_0},
#' \eqn{v_i, 1\le i < N}, \eqn{v_N}.
